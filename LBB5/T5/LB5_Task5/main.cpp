...
{
    setlocale(LC_ALL, "RU");
    cout << "Программа, для составления матрицы из четных столбцов матрицы с нечетными элементами\n";
    cout << "Выполнил Мудрогелов Юрий, группа 453502\n";
    while (true) {
        ...
        cout << "\nРезультат среднего арифметического: " << calc << '\n';
